...
def factory_signature(conn: sqlite3.Connection, job_names: list[str] | None = None) -> str:
    ...
    for table, timestamp in (
        ...
        ("tool_assets", "updated_at"),
        ("tool_usage_events", "recorded_at"),
        ("tool_program_mappings", "updated_at"),
        ("tool_service_records", "created_at"),
        ...
        ("inventory_lots", "updated_at"),
        ("component_requirements", "updated_at"),
        ("component_reservations", "updated_at"),
        ("material_remnants", "updated_at"),
        ("remnant_reservations", "updated_at"),
        ("inventory_movements", "ts"),
