...
INSTALL_ASSETS = [
    ...
    },
    {
        ...
        "command": ".\\deploy\\windows\\build-offline-bundle.ps1 -Version 0.29.0 <installer paths>",
    },
    {
    ...
    },
    {
        ...
        "command": "PYTHONPATH=src python src/offline_release.py <release.zip> --version 0.29.0",
    },
    {
        "key": "backup",
