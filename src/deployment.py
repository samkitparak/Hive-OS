...
INSTALL_ASSETS = [
    ...
    },
    {
        ...
        "command": ".\\deploy\\windows\\build-offline-bundle.ps1 -Version 0.34.0 <installer paths>",
    },
    {
    ...
    },
    {
        ...
        "command": "PYTHONPATH=src python src/offline_release.py <release.zip> --version 0.34.0",
    },
    {
        "key": "backup",
