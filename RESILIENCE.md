...
- `release\HIVE-OS-0.28.0-offline.zip`
- `release\HIVE-OS-0.28.0-offline.zip.sha256`
...
C:\HIVE-OS\deploy\windows\upgrade-hive.ps1 `
  -BundlePath D:\HIVE-OS-0.28.0-offline.zip
```
...
```powershell
D:\HIVE-OS-0.28.0-offline\upgrade-hive.ps1 `
  -BundlePath D:\HIVE-OS-0.28.0-offline
```
